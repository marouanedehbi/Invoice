                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('invoices.update', $invoice) }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                                ...
                                <div class="col">
                                    <label for="text">N° Facture : </label>
                                    <input type="text" class="form-control" id="numFact" name="numFact" maxlength="100"
                            ...
                            <div class="col">
                                ...
                                <select name="societe" id="societe" class="form-control SelectBox" required readonly>
                                    ...
                                    @foreach ($societes as $societe)
                                        @if ($societe->id == $invoice->societe_id)
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker @error('invoice_Date') is-invalid @enderror" name="invoice_Date"
                                       placeholder="DD-MM-YYYY" id="invoice_Date"
                                       type="text" value="{{ (isset($invoice->invoice_date) ? $newDate = date("d-m-Y", strtotime($invoice->invoice_date)) :"") }}" required>
                                @error('invoice_Date')
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker @error('date_pay') is-invalid @enderror" name="date_pay" placeholder="DD-MM-YYYY"
                                       type="text" id = "date_pay"
                                       value="{{ (isset($invoice->payment_date) ? $newDate = date("d-m-Y", strtotime($invoice->payment_date)) :"") }}">
                                @error('date_pay')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="missionType" id="missionType" class="form-control SelectBox @error('missionType') is-invalid @enderror" required>
                                    ...
                                    @foreach ($missionTypes as $missionType)
                                        @if ($missionType->societe_id == $invoice->societe_id)
                                            @if ($missionType->id == $invoice->mission_type_id)
                            ...
                            <div class="col">
                                ...
                                <input class="form-control" name="ICE" id ="ICE"
                                       type="text" maxlength="80" value ="{{ $invoice->ice }}">
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input  class="form-control"  name="ClientAdress" id ="ClientAdress"
                                        type="text" maxlength="200" value ="{{ $invoice->client_adress }}">
                            </div>
                        </div>
                        <br>
                        {{-- 3 --}}
                        <div class="row">
                            ...
                            <div class="col-xl-8">
                                ...
                                <textarea class="form-control @error('detail') is-invalid @enderror" id="detail" name="detail" rows="2"
                                           required>{{ $invoice->detail }}</textarea>
                                @error('detail')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col">
                                ...
                                <input class="form-control" name="REF_BC" id ="REF_BC"
                                       type="text" maxlength="80" value ="{{ $invoice->ref_bc }}">
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" style="text-align:right;" name="remise" id ="remise"  onkeyup="myFunction3()"
                                       oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                       value="{{ $invoice->discount }}"  maxlength="5">
                            </div>
                        ...
                        <br>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" style="text-align:right;" id="Reliquat"
                                           name="Reliquat" value={{$invoice->remainder}} readonly>
                                </div>
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" style="text-align:right;" id="montantHT" name="montantHT"
                                           value={{$invoice->totalHT}}  readonly>
                                </div>
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" style="text-align:right;" id="TotalTTC" name="TotalTTC"
                                           value={{$invoice->totalTTC}}  readonly>
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" style="text-align:right;" id="TotalTTC2" name="TotalTTC2"
                                           value={{$invoice->totalTTC2}}  readonly>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                            ...
                            <div>
                                <input type="hidden" name="montantHTRem" id="montantHTRem" value="{{$invoice->totalHTRem}}" >
                                <input type="hidden" name="montantTVA" id="montantTVA"  value="{{$invoice->montantTVA}}">
                            </div>
                    </form>
                </div>
    ...
    <script type="text/javascript">
        ...
        function  storeTblValues()
        {
            ...
            $('#example11 tr').each(function(row, tr){
                ...
                //$(tr).find('td:eq(3)').text().replace(/\s/g,'');
               // alert ($(tr).find('td:eq(2)').text().replace(/\s/g,''));
            });
