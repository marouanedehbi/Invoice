                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker @error('invoice_Date') is-invalid @enderror" name="invoice_Date"
                                       ...
                                       type="text" value="{{isset($invdate)  ? $invdate : date('d-m-Y') }}" required>
                                @error('invoice_Date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker @error('date_pay') is-invalid @enderror" name="date_pay" placeholder="DD-MM-YYYY"
                                       type="text" id = "date_pay"  value="{{ old('date_pay') }}" >
                                @error('date_pay')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control" name="REF_BC" id ="REF_BC"
                                       type="text" maxlength="80" value="{{ old('REF_BC') }}">
                            </div>
                        </div>
                        <br>
                        @php
