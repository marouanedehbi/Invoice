...
class InvoicesController extends Controller
{
    ...
    public function invoicePaid()
    {
        ...
        $invoices = Invoices::where('value_status', 3)
                    ...
                    ->orderBy('invoice_number', 'DESC')
                    ->get();
        return view('invoices.invoices_paid',compact('invoices', 'societes'));
    }
    ...
    public function invoiceUnPaid()
    {
        ...
        $invoices = Invoices::where('value_status',1)
                    ...
                    ->orderBy('invoice_number', 'DESC')
                    ->get();
        return view('invoices.invoices_unpaid',compact('invoices', 'societes'));
    }
    ...
    public function invoicePartial()
    {
        ...
        $invoices = Invoices::where('value_status',2)
            ...
            ->orderBy('invoice_number', 'DESC')
            ->get();
        return view('invoices.invoices_partial',compact('invoices','societes'));
    }
