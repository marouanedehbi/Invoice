...
class InvoicesController extends Controller
{
    ...
    protected $validationRules = [
       ...
       //  'arrayPrestation' => ["required","array","min:1"],
        // 'arrayPrestation' => ["required","array","min:1"],
         'avance' => 'nullable|numeric',

         // 'date_pay' => 'date|required_if:avance,<=,1',
    ];
    ...
    public function create()
    {
       ...
       $jsValidator->sometimes('date_pay', 'required|date', function ($input) {
           return $input->avance > 0;
       });

        $societes = societe::all();
        $missionTypes = missionType::all();
        return view('invoices.add_invoice')->with([
    ...
    public function store(Request $request)
    {
       ...
       //  $jsValidator->sometimes('date_pay', 'required:date');
     /*  $validator->sometimes('date_pay', 'required|date', function ($input) {
            return $input->avance > 0;
        });*/
